...
from .standard_dialogue import StandardDialogue
from .debate_dialogue import DebateDialogue
...
class DialogueFactory:
    ...
    def create_dialogue(cls, dialogue_type: str, room_id: str, room_data: Optional[Dict[str, Any]] = None) -> BaseDialogue:
        ...
        if not dialogue_class:
            logger.warning(f"Unsupported dialogue type: {dialogue_type}, falling back to standard")
            dialogue_class = StandardDialogue
